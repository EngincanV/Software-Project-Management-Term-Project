    ...
    <div style={{ padding: '50px' }}>
      <Content className="gameBox">
        ...
        <Card className="game" style={{ backgroundColor: 'red' }}>
          ...
          <p>
            Make a card game in Scratch that learns to recognise pictures of
            your card. Teach a computer to recognise what icons look like
          </p>
        ...
        <Card className="game" style={{ backgroundColor: 'Brown' }}>
          ...
          <p>
            Make a postal sorting office in Scratch that can recognise
            handwritten postcodes on envelopes. Teach a computer to recognise
            handwriting
          </p>
          <Button ghost> Start Game</Button>
          <div style={{ marginTop: '20px' }}>
